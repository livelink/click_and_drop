  ...
  class AddressRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClickAndDrop::AddressRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClickAndDrop::AddressRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@full_name.nil? && @full_name.to_s.length > 210
        invalid_properties.push('invalid value for "full_name", the character length must be smaller than or equal to 210.')
      end
      ...
      if !@postcode.nil? && @postcode.to_s.length > 20
    ...
    def valid?
      return false if !@full_name.nil? && @full_name.to_s.length > 210
      ...
      return false if !@postcode.nil? && @postcode.to_s.length > 20
    ...
    def full_name=(full_name)
      if !full_name.nil? && full_name.to_s.length > 210
        fail ArgumentError, 'invalid value for "full_name", the character length must be smaller than or equal to 210.'
      end
    ...
    def hash
      [full_name, company_name, address_line1, address_line2, address_line3, city, county, postcode, country_code].hash
    end
