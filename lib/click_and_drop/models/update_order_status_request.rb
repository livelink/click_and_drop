  ...
  class UpdateOrderStatusRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClickAndDrop::UpdateOrderStatusRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClickAndDrop::UpdateOrderStatusRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'despatch_date')
        self.despatch_date = attributes[:'despatch_date']
      end
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ["new", "despatchedByOtherCourier", "despatched"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["new", "despatchedByOtherCourier", "despatched"])
    ...
    def hash
      [order_identifier, order_reference, status, tracking_number, despatch_date, shipping_carrier, shipping_service].hash
    end
